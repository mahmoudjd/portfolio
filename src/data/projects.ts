export const projects = [
    ...
    },
    {
        ...
        imageUrl: "/assets/mjd-football.png",
        link: "https://github.com/mahmoudjd/abschlussarbeit",
        images: ["/assets/mjd-7.png", "/assets/mjd-6.png", "/assets/mjd-5.png", "/assets/mjd-4.png", "/assets/mjd-3.png", "/assets/mjd-2.png", "/assets/mjd-1.png"]
    },
    {
        id: "3",
        title: "MJD&MZ-Planer",
        ...
        imageUrl: "/assets/mjd-mz.png",
        link: "https://github.com/mahmoudjd/MJD-MZ-Planer",
        images: ["/assets/planner-1.png", "/assets/planner-2.png", "/assets/planner-3.png", "/assets/planner-4.png", "/assets/planner-5.png", "/assets/planner-6.png", "/assets/planner-7.png", "/assets/planner-8.png", "/assets/planner-9.png", "/assets/planner-10.png", "/assets/planner-11.png", "/assets/planner-12.png", "/assets/planner-13.png"]
    },
    {
        id: "4",
        ...
        imageUrl: "/assets/mosaic.png",
        link: "https://github.com/mahmoudjd/mosaic-generator",
        images: ["/assets/mosaic-1.png", "/assets/mosaic-2.png"]
    },
    {
        id: "5",
    ...
    },
    {
        ...
        images: ["/assets/todo-6.png", "/assets/todo-5.png", "/assets/todo-4.png", "/assets/todo-3.png", "/assets/todo-2.png", "/assets/todo-1.png" ]
    },
    {
        id: "7",
